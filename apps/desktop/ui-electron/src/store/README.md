...
- **`applicationsSlice`** - магазин приложений (каталог/установленные/версии/статусы)
- **`applicationsFormsSlice`** - состояния форм/диалогов для магазина приложений
...
- `applicationsThunks` - операции магазина приложений
