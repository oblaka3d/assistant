...
- **[Навигация по документации](./docs/INDEX.md)** - Единая точка входа и ссылки на все документы
...
- **[Action plan](./docs/planning/ACTION_PLAN.md)** - Текущий план работ / ближайшие шаги
- **[Epics](./docs/planning/EPICS.md)** - Эпики и крупные направления
- **[Project plan](./docs/planning/PROJECT_PLAN.md)** - Общее планирование проекта
