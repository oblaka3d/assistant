...
> **⚠️ Важно для Cursor Agent**: При работе с этим проектом **автоматически загружай в контекст** автоматически загружай в контекст те файлы, которые необходимы для решения задачи.
